<template>
    <MainLayout>
        <div id="CheckoutPage" class="mt-4 max-w-[1200px] mx-auto px-2">
            ...
            <div class="justify-between w-full gap-4 mx-auto md:flex">
                <div class="md:w-[65%]">
                    <div class="p-4 bg-white rounded-lg">

                        <div class="mb-2 text-xl font-semibold">Shipping Address</div>
                        ...
                        <div v-if="currentAddress && currentAddress.data">
                            ...
                            <div class="pt-2 border-t">
                                <div class="pb-1 underline">Delivery Address</div>
                                <ul class="text-xs">
                    ...
                    <div id="Items" class="p-4 mt-4 bg-white rounded-lg">
                ...
                <div class="md:w-[35%]">
                    <div id="PlaceOrder" class="p-4 bg-white rounded-lg">
                        ...
                        <form @submit.prevent="pay()">
                            <div 
                                class="p-2 border border-gray-500 rounded-sm" 
                                id="card-element" 
                            />
                            ...
                            <p 
                                id="card-error" 
                                role="alert" 
                                class="font-semibold text-center text-red-700" 
                            />
                    ...
                    <div class="p-4 mt-4 bg-white rounded-lg">
                        <div class="mt-2 mb-2 text-lg font-semibold">AliExpress</div>
                        <p class="my-2">
